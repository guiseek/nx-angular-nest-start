...
    // com o tipo apropriado assim que começarmos a usar o Ivy.
...
   * @returns Uma promessa resolvida para um ComponentRef para o contêiner anexado.
   */
  protected _attachDialogContainer(overlay: OverlayRef, config: DialogConfig): DialogContainer {
    ...
    const containerRef: ComponentRef<DialogContainer> = overlay.attach(containerPortal);
